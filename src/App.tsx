        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto items-center">
          ...
          <FadeIn>
            <div className="bg-white p-8 rounded-2xl border border-stone-200 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <Button primary={false} className="w-full" href="https://app.sellpay.com.br/c/xpsy">
                Quero o Básico
              </Button>
            </div>
          </FadeIn>
          ...
          <FadeIn delay={0.2}>
            <div className="bg-white p-8 rounded-2xl border-2 border-brand-500 shadow-2xl relative transform md:scale-105 z-10">
              ...
              <Button className="w-full flex items-center justify-center gap-2" href="https://app.sellpay.com.br/c/pu5e">
